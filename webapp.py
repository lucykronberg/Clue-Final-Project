...
def renderPage1():
    ...
    mJose = ["I thought I saw something in the quad… or someone. Darwin, my beloved, is that you?", "Are the dons winning? Who’s playing in the gym today?…oh.", "The only thing that’s REALLY being murdered right now is the climate. Although I think I did see something going on inside the school earlier.", "At least a body’s nutrients will be good for soil? *cries*", "I knew there were too many GMOs in today’s meals!", "Do crime scenes count as art?", "We need to spend more time in nature and less around technology…Mr.Al sort of proves my point.", "We cut down thousands of trees to build a place full of books just for someone to be murdered there.", "It’s a dramatic way to go, for sure. I’m sorry I can’t really talk right now."]
    mTormey = ["Is this why I had trouble turning on the TV to show my slides today?", "I heard a pop and maybe a fizz? Riiiight before the screaming started…", "I heard clicking sounds before a scream. Clacking ones too if you will.", "Now my plays can’t be held together!", "You should be taking down notes.", "I’m so mad. First someone steals my Aztec death whistle now my Barbie. I was going to auction it!"]
    mLotze = ["I’m pretty sure that’s in unit 4 of physics? We didn’t get to that though because of the block schedule.", "This murderer has taste!", "I swear students are always stealing my calculators.", "The murder weapon looked like a gun, but none of us were given anything like that…were we?", "It’s not LEAD it’s GRAPHITE people.", "I found a sample of the murder weapon, which was made of polyvinyl chloride, or PVC. Total feta."]
...
def renderPage3():
    ...
    for doc in mongoUser_save.find({"Username":username}):
        ...
        mongoUser_save.update_one({"Username": username}, {'$set': {"Finished":"Yes"}})
    outcome=""
    repeat=""
