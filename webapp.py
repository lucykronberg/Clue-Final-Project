...
def renderPage1():
    ...
    mLotze = ["I’m pretty sure that’s in unit 4 of physics? We didn’t get to that though because of the block schedule.", "I swear students are always stealing my calculators.", "This murderer has taste!", "The murder weapon looked like a gun, but none of us were given anything like that…were we?", "It’s not LEAD it’s GRAPHITE people.", "I found a sample of the murder weapon, which was made of polyvinyl chloride, or PVC. Total feta."]
